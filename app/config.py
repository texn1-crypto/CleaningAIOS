...
class Settings(BaseSettings):
    ...
    tender_search_enabled: bool = True
    tender_search_interval_minutes: int = 240
    tender_search_keywords: str = "уборка|клининг|мойка|мытье|комплексному и хозяйственному обслуживанию"
