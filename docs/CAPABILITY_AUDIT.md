...
| Telegram Control Center | PARTIAL | Exact user/chat RBAC bindings, pseudonymous denial audit, natural Russian text, API-backed tasks and signed durable approvals work. Pagination, Company Brain search, CEO Brief and acknowledged critical alerts remain incomplete. |
