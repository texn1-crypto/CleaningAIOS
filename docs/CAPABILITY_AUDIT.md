...
| Telegram Control Center | PARTIAL | Exact user/chat RBAC bindings, pseudonymous denial audit, natural Russian text, API-backed tasks, signed durable approvals and acknowledged critical alerts work. Pagination, Company Brain search and CEO Brief remain incomplete. |
