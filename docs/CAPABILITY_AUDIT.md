...
| Telegram Control Center | PARTIAL | Exact user/chat RBAC bindings, pseudonymous denial audit, natural Russian text, API-backed tasks, signed durable approvals, acknowledged critical alerts and a source-linked CEO Brief work. Task pagination and Company Brain search remain incomplete. |
