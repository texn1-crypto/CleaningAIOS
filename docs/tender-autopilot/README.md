...
локального выделения кандидатов требований и характеристик товара, а также
проверки решения. Автоматические OCR/сложный table extraction, сопоставление и
review кандидатов, официальные ЕИС/ЭТП adapters, supplier RFQ, подача, ЭЦП,
autobid, платежи и post-win execution ещё не реализованы.
