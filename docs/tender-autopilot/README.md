...
локального выделения кандидатов требований и проверки решения. Автоматические
OCR/table extraction, проверка кандидатов, официальные ЕИС/ЭТП adapters,
supplier RFQ, подача, ЭЦП, autobid, платежи и post-win execution ещё не
реализованы.
