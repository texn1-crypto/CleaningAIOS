...
| Security corpus | PARTIAL | SSRF, approval, storage-boundary и DOCX archive tests покрывают valid input, traversal, duplicate members, excessive entries и compression bomb. Malware/PDF bomb и расширенный document prompt-injection corpus отсутствуют |
